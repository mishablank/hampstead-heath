...
/* the button costs the eyebrow its single line on a phone: break it evenly, not orphaned */
...
@media (max-width:700px){
  .themectl{min-height:40px; padding:5px 13px}
...
/* the longest stop titles run the crumb to three lines: keep the button in the
   corner rather than letting it drift to the middle of them */
...
def siglist():
    ...
    return ('  <ul class="sig">'
            '<li><a href="https://www.linkedin.com/in/mishablank/" target="_blank" '
            'rel="me noopener">LinkedIn</a></li>'
            '<li><a href="https://github.com/mishablank/" target="_blank" '
            'rel="me noopener">GitHub</a></li></ul>')
...
def topbar(lead, crumbed=False):
    ...
    return ('    <div class="topbar%s">%s'
            '<button class="themectl" id="themebtn" type="button">'
            '<i aria-hidden="true"></i><span class="tword">Theme</span> '
            '<span id="themelab">Auto</span></button></div>'
            % (" crumbed" if crumbed else "", lead))
